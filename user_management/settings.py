...
CSRF_USE_SESSIONS = True  # CSRF tokens in session for APIs
CSRF_COOKIE_NAME = 'csrftoken'  # Name of the CSRF cookie
CSRF_COOKIE_HTTPONLY = False  # Set CSRF cookie as HttpOnly
CSRF_COOKIE_SAMESITE = 'Strict'  # Adjust as per security requirements
